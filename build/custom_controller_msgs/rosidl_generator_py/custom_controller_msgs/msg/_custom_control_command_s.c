...
bool custom_controller_msgs__msg__custom_control_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_controller_msgs.msg._custom_control_command.CustomControlCommand", full_classname_dest, 71) == 0);
  }
  custom_controller_msgs__msg__CustomControlCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // kp
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->kp.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // kd
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->kd.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of CustomControlCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_controller_msgs.msg._custom_control_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CustomControlCommand");
  ...
  {  // kp
    ...
    if (ros_message->kp.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->kp.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->kp.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // kd
    ...
    if (ros_message->kd.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->kd.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->kd.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
