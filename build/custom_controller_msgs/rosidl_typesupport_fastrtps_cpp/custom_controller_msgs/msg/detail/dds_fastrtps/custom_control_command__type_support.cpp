...
#include "custom_controller_msgs/msg/detail/custom_control_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_controller_msgs
cdr_serialize(
  const custom_controller_msgs::msg::CustomControlCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_controller_msgs::msg::CustomControlCommand & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_controller_msgs
max_serialized_size_CustomControlCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_controller_msgs::msg::CustomControlCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_controller_msgs::msg::CustomControlCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_controller_msgs::msg::CustomControlCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CustomControlCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_controller_msgs::msg::CustomControlCommand *>(
...
static size_t _CustomControlCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CustomControlCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CustomControlCommand__callbacks = {
...
static rosidl_message_type_support_t _CustomControlCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CustomControlCommand__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_custom_controller_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<custom_controller_msgs::msg::CustomControlCommand>()
{
  return &custom_controller_msgs::msg::typesupport_fastrtps_cpp::_CustomControlCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_controller_msgs, msg, CustomControlCommand)() {
  return &custom_controller_msgs::msg::typesupport_fastrtps_cpp::_CustomControlCommand__handle;
}
